...
Dado('que existem formulários previamente cadastrados e com respostas coletadas no sistema') do
  pessoa_prof = Pessoa.create!(usuario: "prof_resultados", password: "123", password_confirmation: "123", nome: "Professor Resultados")
  docente = Docente.create!(pessoa: pessoa_prof)

  disciplina = Disciplina.create!(nome: "Testes de Software", codigo: "CIC0200")
  @turma = Turma.create!(codigo: "TA_RES", disciplina: disciplina, docente: docente)
  ...
  pessoa_aluno = Pessoa.create!(usuario: "aluno_resultados", password: "123", password_confirmation: "123", nome: "Aluno Resultados")
...
Então('o sistema deve exibir a lista contendo os formulários existentes') do
  expect(page).to have_content(@formulario.template.nome)
end
