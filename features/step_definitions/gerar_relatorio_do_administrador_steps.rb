Dado('que a base de dados possui a pesquisa {string} registrada') do |nome_pesquisa|
  ...
  pessoa_prof = Pessoa.create!(usuario: "prof_relatorio", password: "123", password_confirmation: "123", nome: "Professor Relatorio")
...
Dado('o sistema já processou as respostas submetidas pelos discentes') do
  pessoa_aluno = Pessoa.create!(usuario: "aluno_relatorio", password: "123", password_confirmation: "123", nome: "Aluno Relatorio")
...
Dado('que estou logado no sistema com o perfil padrão de {string}') do |_perfil|
  pessoa_docente = Pessoa.create!(usuario: "docente_relatorio", password: "123", password_confirmation: "123", nome: "Docente Padrao")

  visit login_path
  fill_in 'login', with: pessoa_docente.usuario
